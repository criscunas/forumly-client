                    ...
                    <div className={homeStyles.home__about}>
                        ...
                        >
                            ...
                            <div className={homeStyles.home__about_text}>
                                We are a new platform that allows users to
                                create & share with each other. Users can create
                                blog posts, create threads, post status updates,
                                comment on posts, customize thier profile &
                                follow other users to recieve a personal feed.
                                We are in our early stages & constantly working
                                to enhace your time here. I will be rolling out
                                new features in the future. Feel free to contact
                        ...
                        >
                            ...
                            />
                            <dl>
                                <dt className={homeStyles.home__about_dt}>
                                    {" "}
                                    Profile{" "}
                                </dt>
                                <dd className={homeStyles.home__about_dd}>
                                    ...
                                    profile image. You are able to manage all
                                    blog and post history as well as see
                                ...
                                <dd className={homeStyles.home__about_dd}>
                                    {" "}
                                    Stay up to date with the world as we provide
                                    a feed with all of the the latest headlines
                                    by top news sources. You will also find a
                                    feed of all the people you follow and thier
                                    newest status updates.{" "}
                                </dd>
                                <dt className={homeStyles.home__about_dt}>
                                    {" "}
                                    Discuss{" "}
                                ...
                                <dd className={homeStyles.home__about_dd}>
                                    {" "}
                                    Our discussion section allows users to
                                    create threads on any topic they want to.
                                    Simply click on a thread and you'll be taken
                                    to a main page for that conversation.{" "}
                                </dd>
                            </dl>
                        </Card>
                    </div>
